...
static int verificar_encabezados_algoritmo(datos_csv_t* datos_algoritmo) {
	...
	const char * valores_aceptables[] = {"Año Final","Mes Final","Dia Final","Hora Final","Minuto Final",
                                       "Segundo Final","Resolucion Minutos"};
...
//
static int verificar_parametros_temporales(datos_csv_algoritmo_t* datos_algoritmo,struct tm *fecha_inicial) {
	//Este subprograma se utiliza para verificar
